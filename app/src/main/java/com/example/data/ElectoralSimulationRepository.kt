...
object ElectoralSimulationRepository {
    ...
    // ==========================================
    // SECCIÓN 2: BANCO DINÁMICO DE EXAMEN (25 PREGUNTAS)
    // ==========================================
    val examQuestionsBank: List<ExamQuestion> = listOf(
        // Pregunta 1
        ExamQuestion(
            id = "q1",
        ...
        ExamQuestion(
            ...
            options = listOf("Una falta leve administrativa sin pena", "Un delito sancionado penalmente con prisión", "Una falta que se resuelve con disculpas privadas", "Una infracción solo aplicable en periodo no electoral"),
            correctOptionIndex = 1,
            explanation = "El Art. 55 de la LEIV tipifica la violencia política contra las mujeres como delito penal sancionado con prisión, prohibiendo cualquier acuerdo conciliatorio.",
            normativeReference = "Ley Especial Integral para una Vida Libre de Violencia para las Mujeres (LEIV) Art. 55",
            sourceDocument = "Protocolo de Protección a la Mujer y LEIV"
        ),
        // Pregunta 15
        ExamQuestion(
            id = "q15",
            category = "Organismos Electorales",
            questionText = "¿Cuáles son los cuatro organismos electorales oficiales establecidos por el Código Electoral de El Salvador?",
            situationContext = "Estructura institucional del sistema electoral salvadoreño (Art. 38).",
            options = listOf("TSE, JED, JEM y JRV", "TSE, Asamblea Legislativa, PNC y Fiscalía", "TSE, Alcaldías, Juzgados de Paz y JEM", "TSE, Partidos Políticos, DOE y Vigilantes"),
            correctOptionIndex = 0,
            explanation = "El Art. 38 del Código Electoral establece que son organismos electorales: a) El TSE; b) Las JED; c) Las JEM; y d) Las JRV.",
        ...
        ExamQuestion(
            id = "q16",
            category = "Calificación de Votos",
            questionText = "¿Cómo se califica una papeleta electoral que no tiene ninguna marca de ningún tipo al ser extraída de la urna?",
            situationContext = "Durante el escrutinio preliminar se extrae una papeleta completamente en blanco.",
            type = QuestionType.BALLOT_VALIDITY,
            ballotMarkType = BallotMarkType.NULL_BLANK_BALLOT_WRITTEN,
            ballotVisualDescription = "Papeleta totalmente limpia y sin ninguna marca de votante depositada en la urna.",
            options = listOf("VOTO VÁLIDO", "VOTO NULO", "ABSTENCIÓN", "VOTO IMPUGNADO"),
            correctOptionIndex = 2,
            explanation = "El Art. 203 del Código Electoral define que se entenderán como abstenciones las papeletas depositadas que no tengan marca alguna.",
        ...
        ExamQuestion(
            ...
            questionText = "¿En qué momento y quién aplica la tinta indeleble y retiene/devuelve el DUI al elector?",
            situationContext = "Secuencia de emisión del sufragio conforme al Art. 197 del Código Electoral.",
            options = listOf("Antes de entregar la papeleta por el Presidente", "Inmediatamente después de votar, el 1er Vocal verifica firma/huella, entinta el dedo y devuelve el DUI", "Al entrar al centro escolar por la PNC", "En el escrutinio final"),
            correctOptionIndex = 1,
            explanation = "El Art. 197 inc. final establece que inmediatamente después de que haya votado, el 1er Vocal verifica la firma o huella en el padrón, aplica la tinta indeleble y se devuelve el DUI.",
        ...
        ExamQuestion(
            ...
            questionText = "¿Cuál es la sanción legal para quien se negare sin justa causa a integrar una JRV o abandonare el cargo?",
            situationContext = "Un ciudadano sorteado por el TSE rehúsa presentarse a la mesa sin causa justificada.",
            options = listOf("Una amonestación verbal", "Multa de \$25 a \$114.28 USD y restricciones en DUI, antecedentes y trámites migratorios", "Prisión inmediata de 5 años", "Inhabilitación solo para la siguiente elección"),
            correctOptionIndex = 1,
            explanation = "El Art. 242 del Código Electoral impone multa de \$25.00 a \$114.28 USD y faculta al TSE a ordenar restricciones migratorias, de antecedentes y de renovación de DUI.",
        ...
        ExamQuestion(
            id = "q19",
            category = "Escrutinio Preliminar",
            questionText = "¿En qué orden sucesivo obligatorio debe realizarse el escrutinio preliminar si coinciden varias elecciones?",
            situationContext = "Art. 201 del Código Electoral para elecciones simultáneas.",
            options = listOf("1° Concejos Municipales, 2° Diputados, 3° Presidencial", "1° Presidencial, 2° Diputados a la Asamblea Legislativa, 3° PARLACEN, 4° Concejos Municipales", "El orden que decida el Presidente de JRV por sorteo", "Todas simultáneamente"),
            correctOptionIndex = 1,
            explanation = "El Art. 201 del Código Electoral fija el orden estricto: 1° Presidencial, 2° Diputados Asamblea Legislativa, 3° PARLACEN y 4° Concejos Municipales.",
        ...
        ExamQuestion(
            id = "q20",
            category = "Calificación de Votos",
            questionText = "¿Cómo se califica un voto cuando la marca se sale ligeramente del recuadro de la bandera pero es evidente la preferencia?",
            situationContext = "El elector marcó sobre la bandera de un partido y el trazo del crayón sobrepasa 1 centímetro el borde sin tocar otra bandera.",
            type = QuestionType.BALLOT_VALIDITY,
            ballotMarkType = BallotMarkType.VALID_SLIGHT_OVERFLOW_CROSS,
            ballotVisualDescription = "Marca sobre la bandera del Partido B con trazo que sobrepasa ligeramente el margen hacia espacio neutro.",
            options = listOf("VOTO NULO", "VOTO VÁLIDO", "VOTO IMPUGNADO", "ABSTENCIÓN"),
            correctOptionIndex = 1,
            explanation = "El Art. 205 del Código Electoral privilegia la voluntad clara e inequívoca del votante. Al no tocar otra bandera rival, el voto es plenamente válido.",
        ...
        ExamQuestion(
            id = "q21",
            category = "Votación de Personal de Seguridad",
            questionText = "¿Dónde votan los miembros de la PNC, Academia Nacional de Seguridad Pública y Fuerza Armada destacados en un centro escolar?",
            situationContext = "Conforme al Art. 195 inc. 3° del Código Electoral para personal de seguridad en servicio.",
            options = listOf("En cualquier JRV que elijan libremente", "En la última Junta Receptora de Votos (JRV) de dicho centro de votación", "No pueden votar mientras estén uniformados", "Únicamente en su lugar de residencia"),
            correctOptionIndex = 1,
            explanation = "El Art. 195 inc. 3° del Código Electoral dispone que ejercerán su sufragio en la ÚLTIMA JRV del centro de votación donde se encuentren destacados.",
    ...
    fun getRandom25ExamQuestions(): List<ExamQuestion> {
        return examQuestionsBank.shuffled().take(25)
    }
}
